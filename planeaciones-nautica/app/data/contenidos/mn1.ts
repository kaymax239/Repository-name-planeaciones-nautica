// MN — I Semestre (PPE_LMN_FIDENA_2022).
...
export const contenidosMN1: Record<string, ProgramaOficial> = {
  "Álgebra": {
    "clave": "ALG103",
    "nombre": "Álgebra",
    ...
    "unidades": [
      ...
      },
      {
        ...
        "objetivoEspecifico": "Resolver sistemas de ecuaciones con método de determinantes, Gauss, Gauss-Jordan y matriz inversa, para.",
        "subtemas": [
    ...
    "bibliografia": [
      "Álgebra y Trigonometría con Geometría SWOKOWSKI, Earl W.",
      "Analítica Grupo 1988",
      "BALDOR, Aurelio",
      "Álgebra REES, Paul SPARKS, Fred Editorial",
      "Álgebra Iberoamérica",
      "Publicaciones 2009",
      "Culturales",
      "Reverte 2003"
    ],
    "fuente": "PPE_LMN_FIDENA_2022-_01SEM_LMN_S1.3_ALG103.pdf"
  },
  "Educación Física I": {
    "clave": "C0011",
    ...
    "bibliografia": [
      "Las actividades en la naturaleza. ALONSO, V. Curso de asesores Técnicos 1990",
      "de Educación Física",
      "Preparación física del fútbol basada en el ÁLVAREZ DEL VILLAR, C. Gymnos 1987",
      "atletismo",
      "Estirándose ANDERSON, B. Shelter Publication 1980"
    ],
    "fuente": "PPE_LMN_FIDENA_2022-_01SEM_LMN_S1.8_C0011.pdf"
  },
  "Estrategias de Aprendizaje": {
    ...
    "bibliografia": [
      "Estrategias docentes para un aprendizaje Díaz Barriga A. F, Hernández, Mc Graw Hill 1997",
      "significativo. R. G.",
      "Estrategias docentes para un aprendizaje Díaz Barriga A. F. y Hernández Mc Graw Hill 1999",
      "significativo R. G.",
      "2",
      "Red Telemática de Salud 1998",
      "en Cuba"
    ],
    "fuente": "PPE_LMN_FIDENA_2022-_01SEM_LMN_S1.9_C0099.pdf"
  },
  "Expresión Oral y Escrita": {
    ...
    "bibliografia": [
      ...
      "Ciencias de la Comunicación Zarzar Charu, Carlos Publicaciones Cultural 2003",
      "Leer para aprender",
      "Cuevas Salmones, María de Compañía Editorial Nueva 2002",
      "Lourdes Imagen",
      "Palacios Sierra, Margarita, Alva Pearson 1997",
      "Valentina Carrizal Arévalo y",
      "Yolanda Pérez Rodríguez.",
      "Alhambra Mexicana"
    ],
    "fuente": "PPE_LMN_FIDENA_2022-_01SEM_LMN_S1.10_C0100.pdf"
  },
  "Dibujo de Ingeniería": {
    ...
    "unidades": [
      ...
      },
      {
        "numero": 6,
        "tema": "Simbología",
        "objetivoEspecifico": "Identificar y dibujar los distintos símbolos utilizados en planos del ramo marítimo para su correcta interpretación.",
        "subtemas": [
    ...
    "bibliografia": [
      "Dibujo de Ingeniería CAMBEROS, Alberto Porrúa 1998",
      "Introducción al Dibujo de Ingeniería LUZADDER, Warren CECSA 1996",
      "Manual Práctico de dibujo técnico SCHNEIDER, H SAPPERT, D Reverte 2010"
    ],
    "fuente": "PPE_LMN_FIDENA_2022-_01SEM_LMN_S1.5_DII105_-_.pdf"
  },
  "Electricidad": {
    "clave": "ELE106",
    "nombre": "Electricidad",
    ...
    "unidades": [
      {
        "numero": 1,
        "tema": "Electrostática",
        "objetivoEspecifico": "Comprender los conceptos básicos de electricidad, experimentando la atracción y repulsión mediante prácticas, para comprobar las Ley de cargas eléctricas.",
        "subtemas": [
      ...
      },
      {
        ...
        "objetivoEspecifico": "Conocer los valores de las distintas resistencias, mediante el uso del código de colores, para utilizarlo adecuadamente.",
        "subtemas": [
      ...
      },
      {
        ...
        "objetivoEspecifico": "Comprender a través e diagramas las Leyes de Ohm y Kirchhoff, para conocer sus parámetros.",
        "subtemas": [
          "3.1 La Ley de Ohm.",
      ...
      },
      {
        ...
        "objetivoEspecifico": "Analizar las conexiones de circuitos estrella/delta, con esquemas eléctricos, para resolver sus equivalencias y adecuada aplicación.",
        "subtemas": [
    ...
    "bibliografia": [
      "Tratado de Electricidad volumen 1 DAWES, Chester L. Gustavo Gili, S.A. 1998",
      "Física volumen II HALLIDAD y RESNICK",
      "Física volumen ll SERWAY, Raymond CECSA 2000",
      "Mc Graw Hill 2002"
    ],
    "fuente": "PPE_LMN_FIDENA_2022-_01SEM_LMN_S1.6_ELE106.pdf"
  },
  "Física": {
    "clave": "FIS104",
    "nombre": "Física",
    ...
    "unidades": [
      {
        "numero": 1,
        "tema": "Mecánica",
        "objetivoEspecifico": "Utilizar las magnitudes fundamentales así como las derivadas en Internacional al Sistema Inglés y de éste al la resolución de problemas.",
        "subtemas": [
          "1.1 Mediciones",
          "1.1.1 Magnitudes fundamentales y derivadas del Sistema Internacional conversiones del Sistema y unidades.",
          "1.1.2 Magnitudes fundamentales y derivadas del Sistema Inglés.",
          "1.1.3 Múltiplos y submúltiplos del Sistema Internacional y del Sistema Sistema Internacional, en Inglés.",
          "1.1.4 Magnitudes escalares y vectoriales.",
          "1.1.5 Suma gráfica y analítica (componentes) de vectores.",
          ...
          "1.4.1 Relación entre desplazamiento angular y lineal, partiendo de la definición de radián.",
          "1.4.2 Relación entre velocidad angular constante y velocidad tangencial constante.",
          "1.4.3 Concepto de velocidad angular, velocidad instantánea y velocidad",
          "1.4.4 media.",
          "1.4.5 Concepto de aceleración angular constante como cambio de la velocidad angular de un cuerpo. Concepto de fuerza centrífuga y fuerza centrípeta.",
          "1.5 Leyes de Newton",
      ...
      },
      {
        "numero": 2,
        "tema": "Trabajo",
        "objetivoEspecifico": "Relacionar el trabajo, la energía y la potencia, deducciones algebráicas, con conceptos.",
        "subtemas": [
          "2.1 Trabajo, energía y potencia",
          "2.1.1 Concepto de trabajo mecánico, sus unidades y el efecto de las mediante ejercicios y fuerzas de fricción en su realización.",
          "2.1.2 Problemas relacionados con trabajo mecánico utilizando análisis para resolver problemas dimensional.",
          "2.1.3 Concepto de energía mecánica y su división en energía cinética, aparentemente ajenos potencia, unidades y el principio de conservación de la energía. entre sí.",
      ...
      },
      {
        ...
        "subtemas": [
          ...
          "3.1.2 Densidad, densidad relativa y peso específico relativo.",
          ...
          "3.2.1 Diferencia entre calor y temperatura. Efectos del calor.",
          "3.2.2 El termómetro, las escalas para mediar la temperatura y conversiones entre ellas.",
          "3.2.3 Dilatación lineal, superficial, volumétrica y coeficiente de dilatación."
        ],
        "transversal": false
      },
      {
        ...
        "subtemas": [
          ...
          "4.1.2 Movimiento ondulatorio periódico y el significado de los términos: y el sonido, para frecuencia, periodo, longitud de onda, amplitud de onda, comprender fenómenos velocidad.",
          "4.1.3 Diferencia entre onda transversal y onda longitudinal.",
    ...
    "bibliografia": [
      ...
      "Varios autores. Física I. Primer cuatrimestre de Ingeniería Industrial. Curso 1998-99. Dpto. Física Aplicada I, E. T. S. I. Industriales y",
      "de Telecomunicación (Bilbao).",
      "Varios autores. Física II. Segundo cuatrimestre de Ingeniería Industrial. Curso 1998-99. Dpto. Física Aplicada I, E. T. S. I."
    ],
    "fuente": "PPE_LMN_FIDENA_2022-_01SEM_LMN_S1.4_FIS104.pdf"
  },
  "Prácticas Marineras I": {
    ...
    "unidades": [
      {
        "numero": 1,
        "tema": "Natación",
        "objetivoEspecifico": "Identificar los tipos de navegación, conociendo los fundamentos, para explicar sus diferencias.",
        "subtemas": [
          "1.1 Flotación.",
          "1.2 Uso correcto del Chaleco Salvavidas.",
          "1.3 Nado libre.",
          "1.4 Uso del aro salvavidas.",
          "1.5 Colocación en el agua de los medios de salvamento. sus diferentes modalidades a bordo de"
        ],
        "transversal": false
      },
      {
        ...
        "objetivoEspecifico": "Conocer tipos y accesorios de botes salvavidas, a través de reglas de SOLAS, para verificar el equipo que debe contener el bote.",
        "subtemas": [
      ...
      },
      {
        "numero": 3,
        "tema": "Boga",
        "objetivoEspecifico": "Practicar y organizar equipos de boga en botes salvavidas, para el buen desempeño y seguimiento de las órdenes.",
        "subtemas": [
    ...
    "bibliografia": [
      "The theory and practice of seamanship DANTON, Graham",
      "Routledge & Kegan 2002",
      "Paul Uk",
      "Tratado de maniobras torno I BARBUDO E., Ignacio Fragata 1998",
      "The boatswain’s manual Mc LEOD, William",
      "A.G.W. Miller 2000"
    ],
    "fuente": "PPE_LMN_FIDENA_2022-_01SEM_LMN_S1.7_PMR107.pdf"
  },
  "Transporte Marítimo": {
    "clave": "TMO101",
    ...
    "unidades": [
      ...
      },
      {
        ...
        "subtemas": [
          ...
          "2.4 La interrelación entre el transporte marítimo, el puerto y los otros para destacar el papel de los buques medios de transporte.",
      ...
      {
        "numero": 3,
        "tema": "Organismos Internacionales que regulan la Marina Mercante Relacionar la participación de los Nacional",
        "objetivoEspecifico": "Pendiente de revisión",
        "subtemas": [
      ...
      },
      {
        ...
        "objetivoEspecifico": "Pendiente de revisión",
        "subtemas": [
          "6.1 Refuerzos adicionales en proa y popa, para reforzar estructuralmente secciones de proa y popa, analizando los y soportar los golpes de mar.",
      ...
      },
      {
        ...
        "objetivoEspecifico": "Identificar y describir la distribución de los componentes usados en maniobras de atraque/desatraque y fondeo, analizando sus características e implicaciones, para las operaciones en forma segura.",
        "subtemas": [
          "7.1 Estanqueidad en las tapas de escotillas mecánicas modernas. componentes usados en maniobras de",
          "7.2 Estanqueidad en accesos.",
          "7.3 Limpieza de las tapas de escotillas.",
      ...
      },
      {
        ...
        "subtemas": [
          ...
          "8.5 Descripción del sistema de gobierno. Descripción del sistema de propulsión."
        ],
        "transversal": false
      },
      {
        ...
        "objetivoEspecifico": "Identificar y describir la distribución y capacidad de tanques en el buque, así como tubos sonda y respiraderos, desarrollando actividades teórico/prácticas, pasa su eficiente aplicación.",
        "subtemas": [
      ...
      {
        "numero": 11,
        "tema": "Esfuerzos en el buque Identificación de equipos que determinan esfuerzos.",
        "objetivoEspecifico": "Pendiente de revisión",
        "subtemas": [],
        "transversal": false
      },
    ...
    "bibliografia": [
      "Transporte Marítimo",
      "Logística del Transporte ROMERO, Rosa Marge Books 2002",
      "Cultura Marítima",
      "LEÓN, Alex ROMERO, Rosa Marge Books 2003",
      "Cap. OCAMPO , José ENV 2002"
    ],
    "fuente": "PPE_LMN_FIDENA_2022-_01SEM_LMN_S1.1_TMO101.pdf"
  }
};
